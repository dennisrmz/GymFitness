...
<div class="seccion-areas">
    <ul class="contenedor-areas">
        <li class="area">
            ...
            ?>
            <img src="<?php echo esc_attr($imagen); ?>" alt="area_1">
        ...
        <li class="area">
            ...
            ?>
            <img src="<?php echo esc_attr($imagen); ?>" alt="area_2">
        ...
        <li class="area">
            ...
            ?>
            <img src="<?php echo esc_attr($imagen); ?>" alt="area_3">
        ...
        <li class="area">
            ...
            ?>
            <img src="<?php echo esc_attr($imagen); ?>" alt="area_4">
...
<section class="blog contenedor seccion">
    ...
    <?php 
        ...
        while($blog->have_posts()): $blog->the_post();
            ...
            get_template_part( 'template-parts/loop-blog', 'blog'); 
